...
const Blogs = () => {
    ...
    const getAllBlogs = async () => {
        ...
        const response = await fetch('http://localhost:8000/api/addPosts/posts', {
            method: 'GET',
            headers: {
  ...
  return (
    <>
        <section className="bg-white dark:bg-gray-900 h-[100%] w-[100%]">
            <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                ...
                <div className="grid gap-8 lg:grid-cols-2">
                    {blogs.map((blog) => {
                        return (
                            <article key={blog._id} className="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <p className="mb-5 font-light text-gray-500 dark:text-gray-400">{blog.about}</p>
